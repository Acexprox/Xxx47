...
<button 
  ...
  className="hero-button video-demo-button border-2 border-gray-300 text-gray-700 px-8 py-4 rounded-xl font-semibold text-lg hover:border-yellow-500 hover:text-yellow-600 hover:shadow-xl hover:scale-105 transition-all duration-300 flex items-center justify-center gap-2 relative group"
>
...
<button 
  onClick={() => setIsVideoModalOpen(true)}
  className="hero-button video-demo-button border-2 border-gray-300 text-gray-700 px-6 py-3 rounded-xl font-semibold text-base hover:border-yellow-500 hover:text-yellow-600 hover:shadow-xl hover:scale-105 transition-all duration-300 flex items-center justify-center gap-2 relative group"
>
<span className="play-icon-wrapper relative">
